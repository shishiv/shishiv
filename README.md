...
- 🔬 former fapemig scholar
- 💼 former director of information systems @ avance consulting jr.

i believe in "slow is fast" — taking the time to build it right instead of pushing out broken code. i write code in english, think in portuguese, and debug in whatever language the error message is in.

---

i'm looking for remote full-stack dev opportunities. if you're building something cool with react, next.js, typescript, or node.js — let's talk.
...
- 🏆 1º lugar fator s (sebrae) — competição de startups no scti uemg 2024
- 🎓 sistemas de informação @ uemg frutal (formando 2028)
- 🔬 ex-bolsista fapemig
- 💼 ex-diretor de sistemas de informação @ avance consulting jr.

acredito em "slow is fast" — dedicar tempo pra construir direito em vez de sair empurrando código quebrado. escrevo código em inglês, penso em português, e debugo em qualquer idioma que a mensagem de erro estiver.
